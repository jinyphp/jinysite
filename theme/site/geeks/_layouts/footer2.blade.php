        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="mb-4">
                    ...
                    <div class="mt-4">
                        <p>Geek2 is feature-rich components and beautifully Bootstrap UIKit for developers, built with bootstrap responsive framework.</p>
                        <!-- social media -->
                        <div class="fs-4 mt-4">
                            <!--Facebook-->
                            <a href="#" class="me-2">
            ...
            <div class="offset-lg-1 col-lg-2 col-md-3 col-6">
                <div class="mb-4">
                    <!-- list -->
                    <h3 class="fw-bold mb-3">Company2</h3>
