       ...
       <div class="container px-3">
          ...
          <div class="offcanvas offcanvas-start offcanvas-nav" style="width: 20rem">
             <div class="offcanvas-header">
                <a href="/" class="text-inverse"><img src="/assets/images/logo/logo.svg" alt /></a>
             ...
             <div class="offcanvas-body pt-0 align-items-center">
                <ul class="navbar-nav mx-auto align-items-lg-center">
                   <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu">
                         <li><a class="dropdown-item" href="/">Landing Overview</a></li>
                         <li><a class="dropdown-item" href="/landing-sass-v1">Saas v.1</a></li>
                         <li><a class="dropdown-item" href="/landing-sass-v2">Sass v.2</a></li>
                         <li><a class="dropdown-item" href="/landing-accounting">Accounting</a></li>
                         <li><a class="dropdown-item" href="/landing-finance">Finance</a></li>
                         <li><a class="dropdown-item" href="/landing-jamstack-agancy">Jamstack Agency</a></li>
                         <li><a class="dropdown-item" href="/landing-conference">Conference</a></li>
                         <li><a class="dropdown-item" href="/landing-personal">Personal</a></li>
                      </ul>
                   </li>
                   <li class="nav-item dropdown">
                            ...
                            <div class="col">
                               <div>
                                  <div>
                                     ...
                                     <a class="dropdown-item" href="/blog-list-view">List View</a>
                                     <a class="dropdown-item" href="/blog">Grid View</a>
                                     <a class="dropdown-item" href="/blog-grid-thumbnail">Grid View v.2</a>
                                     <a class="dropdown-item" href="/blog-sidebar">Sidebar</a>
                                     <a class="dropdown-item" href="/blog-category">Category</a>
                                     <a class="dropdown-item" href="/blog-single">Single Post</a>
                                  </div>
                                  <div class="mt-3">
                                     <div class="dropdown-header">About</div>
                                     <a class="dropdown-item" href="/about">About v.1</a>
                                     <a class="dropdown-item" href="/about-v2">About v.2</a>
                                  </div>
                               </div>
                            </div>
                            <div class="col">
                               <div class="mt-3 mt-lg-0">
                                  <div>
                                     ...
                                     <a class="dropdown-item" href="/service-v1">Service v.1</a>
                                     <a class="dropdown-item" href="/service-v2">Service v.2</a>
                                     <a class="dropdown-item" href="/service-v3">Service v.3</a>
                                  </div>
                                  <div class="mt-3">
                                     <div class="dropdown-header">Events</div>

                                     <a class="dropdown-item" href="/events">List</a>
                                     <a class="dropdown-item" href="/event-single">Single</a>
                                  </div>
                                  <div class="mt-3">
                                     <div class="dropdown-header">Contact</div>

                                     <a class="dropdown-item" href="/contact-1">Contact Us</a>
                                     <a class="dropdown-item" href="/contact-2">Contact Sales</a>
                                  </div>
                               </div>
                            </div>
                            <div class="col">
                               <div class="mt-3 mt-lg-0">
                                  <div>
                                     ...
                                     <a class="dropdown-item" href="/portfolio">Grid View</a>

                                     <a class="dropdown-item" href="/portfolio-single">Single View</a>
                                  </div>
                                  <div class="mt-3">
                                     <div class="dropdown-header">Pricing</div>
                                     <a class="dropdown-item" href="/pricing-v1">Pricing v.1</a>
                                     <a class="dropdown-item" href="/pricing-v2">Pricing v.2</a>
                                  </div>
                                  <div class="mt-3">
                            ...
                            <div class="col">
                               <div class="mt-3 mt-lg-0">
                                  <div>
                                     ...
                                     <a class="dropdown-item" href="/integration">Grid View</a>
                                     <a class="dropdown-item" href="/integration-single">Single</a>
                                  </div>
                               </div>
                            </div>
                         </div>
                   ...
                   <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu">
                         ...
                         <li><a class="dropdown-item" href="/account-team">Team</a></li>
                         <li><a class="dropdown-item" href="/account-notification">Notifications</a></li>
                         <li><a class="dropdown-item" href="/account-app-integration">Integration</a></li>
                         <li><a class="dropdown-item" href="/account-device-session">Session</a></li>
                         <li><a class="dropdown-item" href="/account-social-links">Social</a></li>
                         <li><a class="dropdown-item" href="/account-appearance">Appearance</a></li>
                         <li class="dropdown-submenu dropend">
                            ...
                            <ul class="dropdown-menu">
                               ...
                               <li>
                                  <a class="dropdown-item" href="/forget-password">Forget Password</a>
                               </li>
                               <li>
                                  <a class="dropdown-item" href="/reset-password">Reset Password</a>
                               </li>
                               <li>
                                  <a class="dropdown-item" href="/otp-varification">OTP Varification</a>
                               </li>
                               <li><hr class="dropdown-divider" /></li>
                               <li class="dropdown-header">Side Cover</li>

                               <li>
                                  <a class="dropdown-item" href="/signin-v2">Sign In</a>
                               </li>

                               <li>
                                  <a class="dropdown-item" href="/signup-v2">Sign Up</a>
                               </li>

                               <li>
                                  <a class="dropdown-item" href="/forget-password-v2">Forget Password</a>
                               </li>
                               <li>
                                  <a class="dropdown-item" href="/reset-password-v2">Reset Password</a>
                               </li>
                               <li>
                                  <a class="dropdown-item" href="/otp-varification-v2">OTP Varification</a>
                               </li>
                            </ul>
                         </li>
                         <li class="dropdown-submenu dropend">
                            ...
                            <ul class="dropdown-menu">
                               <li>
                                  <a class="dropdown-item" href="/404-error">404 Error</a>
                               </li>
                               <li>
                ...
                <div class="mt-3 mt-lg-0 d-flex align-items-center">
                   <a href="/signin" class="btn btn-light mx-2">Login</a>
