                     ...
                     <div class="col-lg-5 col-md-6 col-12" data-cue="slideInLeft">
                        <div data-cue="fadeIn">
                           ...
                           <div class="mb-5 mt-4">
                              ...
                              <p class="mb-0 lead">Track your entire project from start to finish with beautiful views that make project planning a breeze.</p>
                           </div>
                     ...
                     <div class="col-lg-5 offset-lg-1 col-md-6 col-12 order-lg-2" data-cue="slideInRight">
                        <div class="mt-md-5">
                           ...
                           <div class="mb-5 mt-4">
                              ...
                              <p class="lead mb-0">Collaborate and build total alignment on your project by adding comments to any task or document.</p>
                           </div>
                           ...
                           <div class="swiper-wrapper pb-6">
                                 ...
                                 <div class="card">
                                    <div class="row align-items-center">
                                       <div class="col-xl-4 col-lg-5 col-md-6 overflow-hidden d-none d-lg-block">
                                          <img src="./assets/images/testimonial/testimonial-img-1.jpg" class="img-fluid rounded-start-md-3 rounded-top-md-0 rounded-top-3" alt="testimonials" />
                                       </div>
                              ...
                              <div class="swiper-slide">
                                 <div class="card">
                                    <div class="row align-items-center">
                                       <div class="col-xl-4 col-lg-5 col-md-6 overflow-hidden d-none d-lg-block">
                                          <img src="./assets/images/testimonial/testimonial-img-2.jpg" class="img-fluid rounded-start-md-3 rounded-top-md-0 rounded-top-3" alt="testimonials" />
                                       </div>
                                       <div class="col-xl-8 col-lg-7 col-md-12">
                                          <div class="card-body p-4 px-xl-0">
                                             <div class="mb-6 text-inverse">
                              ...
                              <div class="swiper-slide">
                                 <div class="card">
                                    <div class="row align-items-center">
                                       <div class="col-xl-4 col-lg-5 col-md-6 overflow-hidden d-none d-lg-block">
                                          <img src="./assets/images/testimonial/testimonial-img-3.jpg" class="img-fluid rounded-start-md-3 rounded-top-md-0 rounded-top-3" alt="testimonials" />
                                       </div>
                                       <div class="col-xl-8 col-lg-7 col-md-12">
                                          <div class="card-body p-4 px-xl-0">
                                             <div class="mb-6 text-inverse">
                  ...
                  <div class="row mb-7 pb-2 text-center justify-content-center g-0">
                        ...
                        <div class="marquee" data-cue="slideInLeft">
                           <div class="track">
                              <a href="#" class="btn btn-light rounded-pill me-1 mb-3 btn-logo btn-lift">
                                 <span><img src="./assets/images/integration-logo/integrate-logo-1.svg" alt="logo" class="icon-xs" /></span>
                                 <span class="ms-1 d-none d-lg-inline-flex">Microsoft Team</span>
                              </a>
                              <a href="#" class="btn btn-light rounded-pill me-1 mb-3 btn-logo btn-lift">
                                 <span><img src="./assets/images/integration-logo/integrate-logo-12.svg" alt="logo" class="icon-xs" /></span>
                                 <span class="ms-1 d-none d-lg-inline-flex">Calendar</span>
                              </a>
                              <a href="#" class="btn btn-light rounded-pill me-1 mb-3 btn-logo btn-lift">
                                 <span><img src="./assets/images/integration-logo/integrate-logo-9.svg" alt="logo" class="icon-xs" /></span>
                                 <span class="ms-1 d-none d-lg-inline-flex">Jira</span>
                              </a>
                              <a href="#" class="btn btn-light rounded-pill me-1 mb-3 btn-logo btn-lift">
                                 <span><img src="./assets/images/integration-logo/integrate-logo-4.svg" alt="logo" class="icon-xs" /></span>
                                 <span class="ms-1 d-none d-lg-inline-flex">Slack</span>
                              </a>
                              <a href="#" class="btn btn-light rounded-pill me-1 mb-3 btn-logo btn-lift">
                                 <span><img src="./assets/images/integration-logo/integrate-logo-15.svg" alt="logo" class="icon-xs" /></span>
                                 <span class="ms-1 d-none d-lg-inline-flex">Salesforce</span>
                              </a>
                              <a href="#" class="btn btn-light rounded-pill me-1 mb-3 btn-logo btn-lift">
                                 <span><img src="./assets/images/integration-logo/integrate-logo-2.svg" alt="logo" class="icon-xs" /></span>
                                 <span class="ms-1 d-none d-lg-inline-flex">Zoom</span>
                              </a>
                              <a href="#" class="btn btn-light rounded-pill me-1 mb-3 btn-logo btn-lift">
                                 <span><img src="./assets/images/integration-logo/integrate-logo-3.svg" alt="logo" class="icon-xs" /></span>
                     ...
                     <div class="col-lg-12 col-12 px-lg-7">
                        <div class="marquee" data-cue="slideInRight">
                           <div class="track-2">
                              <a href="#" class="btn btn-light rounded-pill me-1 mb-3 btn-logo btn-lift">
                                 <span><img src="./assets/images/integration-logo/integrate-logo-7.svg" alt="logo" class="icon-xs" /></span>
                                 <span class="ms-1 d-none d-lg-inline-flex">MS Teams</span>
                              </a>
                              <a href="#" class="btn btn-light rounded-pill me-1 mb-3 btn-logo btn-lift">
                                 <span><img src="./assets/images/integration-logo/integrate-logo-10.svg" alt="logo" class="icon-xs" /></span>
                                 <span class="ms-1 d-none d-lg-inline-flex">HubSpot</span>
                              </a>
                              <a href="#" class="btn btn-light rounded-pill me-1 mb-3 btn-logo btn-lift">
                                 <span><img src="./assets/images/integration-logo/integrate-logo-6.svg" alt="logo" class="icon-xs" /></span>
                              ...
                              <a href="#" class="btn btn-light rounded-pill me-1 mb-3 btn-logo btn-lift">
                                 <span><img src="./assets/images/integration-logo/integrate-logo-14.svg" alt="logo" class="icon-xs" /></span>
                                 <span class="ms-1 d-none d-lg-inline-flex">GitHub</span>
                              </a>
                              <a href="#" class="btn btn-light rounded-pill me-1 mb-3 btn-logo btn-lift">
                                 <span><img src="./assets/images/integration-logo/integrate-logo-13.svg" alt="logo" class="icon-xs" /></span>
                                 <span class="ms-1 d-none d-lg-inline-flex">Gmail</span>
                              </a>
                              <a href="#" class="btn btn-light rounded-pill me-1 mb-3 btn-logo btn-lift">
                                 <span><img src="./assets/images/integration-logo/integrate-logo-11.svg" alt="logo" class="icon-xs" /></span>
                     ...
                     <div class="col-lg-12 col-12">
                        <div class="marquee" data-cue="slideInLeft">
                           <div class="track">
                              <a href="#" class="btn btn-light rounded-pill me-1 mb-3 btn-logo btn-lift">
                                 <span><img src="./assets/images/integration-logo/integrate-logo-8.svg" alt="logo" class="icon-xs" /></span>
                              ...
                              <a href="#" class="btn btn-light rounded-pill me-1 mb-3 btn-logo btn-lift">
                                 <span><img src="./assets/images/integration-logo/integrate-logo-5.svg" alt="logo" class="icon-xs" /></span>
                                 <span class="ms-1 d-none d-lg-inline-flex">Salesforce</span>
                              </a>
                              <a href="#" class="btn btn-light rounded-pill me-1 mb-3 btn-logo btn-lift">
                                 <span><img src="./assets/images/integration-logo/integrate-logo-9.svg" alt="logo" class="icon-xs" /></span>
                        ...
                        <div class="position-relative z-1 my-lg-5">
                           ...
                           <form class="row g-2 needs-validation d-flex mx-lg-7" novalidate>
                              <div class="col-md-7 col-xl-7 col-12">
                                 ...
                                 <input type="email" id="notificationEmail" class="form-control" placeholder="Enter your business email" aria-label="Enter your business email" required />
