{{-- geeks footer 2 --}}
<!-- footer 태그 바로 앞에 아래 스타일 코드를 추가합니다 -->
<style>
    .footer {
...
<footer class="pt-lg-8 pt-5 footer bg-white">
    <div class="container mt-lg-2">
        <div class="row border-top pt-6 mt-6">
            <div class="col-lg-4 col-md-6 col-12">
                <!-- about company -->
                <div class="mb-4">
                    <div class="text-lg">JinyPHP</div>

                    <div class="mt-4">
                        <p>JinyPHP는개발자를 위한 기능이 풍부한 컴포넌트와 아름다운 Bootstrap UIKit으로, 부트스트랩 반응형 프레임워크로 구축되었습니다.</p>
                        <!-- social media -->
                        <div class="fs-4 mt-4">
                            <!--Facebook-->
                            <a href="#" class="me-2">
            ...
            <div class="offset-lg-1 col-lg-2 col-md-3 col-6">
                <div class="mb-4">
                    <!-- list -->
                    <h3 class="fs-5 fw-bold mb-3">Company</h3>
            ...
            <div class="col-lg-2 col-md-3 col-6">
                <div class="mb-4">
                    <!-- list -->
                    <h3 class="fs-5 fw-bold mb-3">Support</h3>
                    <ul class="list-unstyled nav nav-footer flex-column nav-x-0">
            ...
            <div class="col-lg-3 col-md-12">
                <!-- contact info -->
                <div class="mb-4">
                    <h3 class="fs-5 fw-bold mb-3">연락하기</h3>
                    <p>서울, 대한민국</p>
                    <p class="mb-1">
                        Email:
                        <a href="#">support@jinyphp.com</a>
                    </p>
                    <p>
                        Phone:
