          ...
          <section class="container mb-4">
            <div class="overflow-auto" data-simplebar data-simplebar-auto-hide="false">
              <div class="row row-cols-6 g-0" style="min-width: 960px">
                <div class="col">
                  <a class="d-flex justify-content-center py-3 px-2 px-xl-3" href="shop-catalog-electronics">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 gy-5">
              ...
              <div class="col">
                <div class="hover-effect-scale">
                  <a class="d-block bg-body-tertiary rounded p-4 mb-4" href="shop-catalog-electronics">
                  ...
                  <h2 class="h6 d-flex w-100 pb-2 mb-1">
                    <a class="animate-underline animate-target d-inline text-truncate" href="shop-catalog-electronics">Smartphones</a>
                  </h2>
                  <ul class="nav flex-column gap-2 mt-n1">
                    ...
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Samsung</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Xiaomi</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Nokia</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Meizu</a>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="col">
                <div class="hover-effect-scale">
                  ...
                  <h2 class="h6 d-flex w-100 pb-2 mb-1">
                    <a class="animate-underline animate-target d-inline text-truncate" href="shop-catalog-electronics">Accessories</a>
                  </h2>
                  <ul class="nav flex-column gap-2 mt-n1">
                    <li class="d-flex w-100 pt-1">
              ...
              <div class="col">
                <div class="hover-effect-scale">
                  ...
                  <h2 class="h6 d-flex w-100 pb-2 mb-1">
                    <a class="animate-underline animate-target d-inline text-truncate" href="shop-catalog-electronics">Tablets</a>
                  </h2>
                  <ul class="nav flex-column gap-2 mt-n1">
                    <li class="d-flex w-100 pt-1">
                    ...
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Lenovo</a>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="col">
                <div class="hover-effect-scale">
                  ...
                  <h2 class="h6 d-flex w-100 pb-2 mb-1">
                    <a class="animate-underline animate-target d-inline text-truncate" href="shop-catalog-electronics">Wearable Electronics</a>
                  </h2>
                  <ul class="nav flex-column gap-2 mt-n1">
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Smart Watches</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                    ...
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">E-books</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                    ...
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Voice Recorders</a>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="col">
                <div class="hover-effect-scale">
                  ...
                  <h2 class="h6 d-flex w-100 pb-2 mb-1">
                    <a class="animate-underline animate-target d-inline text-truncate" href="shop-catalog-electronics">Computers &amp; Laptops</a>
                  </h2>
                  <ul class="nav flex-column gap-2 mt-n1">
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Asus</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Acer</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">HP (Hewlett Packard)</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Lenovo</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Apple MacBook</a>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="col">
                <div class="hover-effect-scale">
                  ...
                  <h2 class="h6 d-flex w-100 pb-2 mb-1">
                    <a class="animate-underline animate-target d-inline text-truncate" href="shop-catalog-electronics">Cameras, Photo &amp; Video</a>
                  </h2>
                  <ul class="nav flex-column gap-2 mt-n1">
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Photo Cameras</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Video Cameras</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Action Cameras</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                    ...
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Studio Equipment</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Tripods</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Bags and Covers</a>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="col">
                <div class="hover-effect-scale">
                  ...
                  <h2 class="h6 d-flex w-100 pb-2 mb-1">
                    <a class="animate-underline animate-target d-inline text-truncate" href="shop-catalog-electronics">Headphones</a>
                  </h2>
                  <ul class="nav flex-column gap-2 mt-n1">
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Apple</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Defunc</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">HyperX</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">JBL</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Logitech</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Panasonic</a>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="col">
                <div class="hover-effect-scale">
                  ...
                  <h2 class="h6 d-flex w-100 pb-2 mb-1">
                    <a class="animate-underline animate-target d-inline text-truncate" href="shop-catalog-electronics">Video Games</a>
                  </h2>
                  <ul class="nav flex-column gap-2 mt-n1">
                    <li class="d-flex w-100 pt-1">
                    ...
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">PlayStation Controllers</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">PlayStation Games</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Gaming PCs</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                    ...
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Xbox Series X/S</a>
                    </li>
                    <li class="d-flex w-100 pt-1">
                      <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics">Gaming Peripherals</a>
                    </li>
                  </ul>
                </div>
              </div>
