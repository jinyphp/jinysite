                ...
                <div class="container">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                            <!-- Bg -->
                            <div class="rounded-top bg-blue-800" style="height: 100px">
                            </div>
                                ...
                                <div class="d-flex align-items-end justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <div
                                            ...
                                            <img src="/assets/images/avatar/avatar-3.jpg"
                                                class="w-24 rounded-circle border border-4 border-white" alt="avatar">
                                        </div>
                                    ...
                                    <div>
                                        <a href="profile-edit.html"
                                            class="btn btn-primary btn-sm d-none d-md-block">Account Setting</a>
                                    </div>
                                </div>
                            </div>
                        </div>
