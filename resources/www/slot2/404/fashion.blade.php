                        ...
                        <div class="col-10 col-sm-7 col-md-6 col-lg-5 col-xxl-4 offset-lg-1 offset-xxl-2 order-md-2">
                            <svg width="447" viewBox="0 0 447 420" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g opacity="0.05" filter="url(#filter0_f_2921_40054)">
                                    <ellipse cx="223.5" cy="371" rx="193.5" ry="19"
                                        fill="#181D25" />
                                </g>
                                <path class="d-none-dark" d="M44 374V97H403V374H44Z"
                                    fill="url(#paint0_linear_2921_40054)" />
                                <path class="d-none d-block-dark" d="M44 374V97H403V374H44Z" fill="#394557" />
                                ...
                                <path class="d-none-dark" d="M67 85V97H44L67 85Z" fill="#cad0d9" />
                                <path class="d-none-dark" d="M380 85V97H403L380 85Z" fill="#cad0d9" />
                                <path class="d-none d-block-dark" d="M67 85V97H44L67 85Z" fill="#303947" />
                                <path class="d-none d-block-dark" d="M380 85V97H403L380 85Z" fill="#303947" />
                                ...
                                <g clip-path="url(#clip0_2921_40054)">
                                    <path class="animate-down-up text-body-emphasis" fill-rule="evenodd"
                                        clip-rule="evenodd"
                                ...
                                <defs>
                                    ...
                                    <linearGradient id="paint0_linear_6256_34079" x1="229.5" y1="101.5"
                                        x2="229.5" y2="74" gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#21262f" />
                                        <stop offset="1" stop-color="#374150" />
                                    </linearGradient>
                                    <clipPath id="clip0_2921_40054">
                                        <rect width="359" height="97" fill="white" transform="translate(44)" />
                                    </clipPath>
                                </defs>
                            </svg>
                        </div>
