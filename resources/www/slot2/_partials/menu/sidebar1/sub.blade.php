<nav class="list-group list-group-borderless">
    ...
    <div class="collapse show" id="menu-{{$code}}-{{$ref}}-{{$i}}"
        style="padding-left: 1rem;">
        @if(isset($item['items']))
        <div style="border-left:1px solid; border-color: #ccc;
            padding-left: 1rem;">
            @includeIf(inSlotPartial("menu.sidebar1".".node"),[
                'ref' => $ref."-".$i,
                'rows' => $item['items']
            ])
