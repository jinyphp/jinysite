...
<body>
  ...
  <main id="content" role="main">
    ...
    <div class="container d-none">
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-4 mb-3 mb-lg-0" data-aos="fade-up">
          <!-- Card -->
          <a class="js-go-to card card-transition h-100" href="#!"
            ...
            <div class="p-2">
              <img class="card-img" src="./assets/svg/illustrations/docs-frame.svg" alt="Image Description">
            </div>
            <div class="card-body">
              <h3 class="card-title text-inherit">Documentation</h3>
              <p class="card-text text-body">Discover how to build and maintain coding systems using our documentation.</p>
            </div>
        ...
        <div class="col-sm-6 col-lg-4 mb-3 mb-lg-0" data-aos="fade-up" data-aos-delay="150">
          <!-- Card -->
          <a class="js-go-to card card-transition h-100" href="#!"
             data-hs-go-to-options='{
            ...
            <div class="p-2">
              <img class="card-img" src="./assets/svg/illustrations/snippets-frame.svg" alt="Image Description">
            </div>
            <div class="card-body">
              <h3 class="card-title text-inherit">Snippets</h3>
              <p class="card-text text-body">Start browsing our snippets pages with copy-to-clipboard snippets to match Bootstrap's level of quality.</p>
            </div>
            <div class="card-footer pt-0">
              <span class="card-link">Start building <i class="bi-chevron-right small"></i></span>
            </div>
          </a>
          <!-- End Card -->
        </div>
        ...
        <div class="col-sm-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
          ...
          <a class="js-go-to card card-transition h-100" href="#!"
            ...
            <div class="p-2">
              <img class="card-img" src="./assets/svg/illustrations/layouts-frame.svg" alt="Image Description">
            </div>
            <div class="card-body">
              <h3 class="card-title text-inherit">Page layouts</h3>
              <p class="card-text text-body">Apart from 70+ HTML-pages, the theme comes with 6 ready-to-use and stand-alone demo options.</p>
            </div>
            <div class="card-footer pt-0">
              <span class="card-link">View examples <i class="bi-chevron-right small"></i></span>
            </div>
          </a>
          <!-- End Card -->
        </div>
    ...
    <div class="container">
      ...
      <div class="w-lg-75 text-center mx-md-auto mb-md-5">
        <h2 class="h1 lh-sm">Made for everyone, build anything with multiple pre-built demos</h2>
      </div>
      <!-- End Heading -->
      ...
      <div class="row align-items-md-center content-space-2 content-space-b-lg-2">
        <div class="col-md-6 order-md-2 mb-10 mb-md-0">
          ...
          <figure class="device-browser">
            ...
            <div class="device-browser-frame">
              <img class="device-browser-img" src="./assets/img/1618x1010/img7.jpg" alt="Image Description">
            </div>
        ...
        <div class="col-md-6">
          <div class="pe-md-7">
            <div class="mb-5">
              <div class="mb-5">
                <span class="badge border border-dark text-dark">59 Pages</span>
              </div>
      ...
      <div class="row align-items-md-center content-space-2 content-space-b-lg-2">
        <div class="col-md-6 order-md-2 mb-10 mb-md-0">
          ...
          <figure class="device-browser">
            ...
            <div class="device-browser-frame">
              <img class="device-browser-img" src="./assets/img/1618x1010/img9.jpg" alt="Image Description">
            </div>
        ...
        <div class="col-md-6">
          <div class="pe-md-7">
            <div class="mb-5">
              <div class="mb-5">
                <span class="badge border border-dark text-dark">10 Pages</span>
              </div>
      ...
      <div class="row align-items-md-center content-space-2 content-space-b-lg-2">
        ...
        <div class="col-md-6">
          <div class="pe-md-7">
            <div class="mb-5">
              <div class="mb-5">
                <span class="badge border border-dark text-dark">9 Pages</span>
              </div>
      ...
      <div class="row align-items-md-center content-space-2 content-space-b-lg-2">
        <div class="col-md-6 order-md-2 mb-10 mb-md-0">
          ...
          <figure class="device-browser">
            ...
            <div class="device-browser-frame">
              <img class="device-browser-img" src="./assets/img/1618x1010/img8.jpg" alt="Image Description">
            </div>
        ...
        <div class="col-md-6">
          <div class="pe-md-7">
            <div class="mb-5">
              <div class="mb-5">
                <span class="badge border border-dark text-dark">5 Pages</span>
              </div>
      ...
      <div class="row align-items-md-center content-space-2 content-space-b-lg-2">
        <div class="col-md-6 order-md-2 mb-10 mb-md-0">
          ...
          <figure class="device-browser">
            ...
            <div class="position-absolute bottom-0 start-0 w-100 h-100 bg-soft-info zi-n1 mb-n6 ms-n6"></div>
          </figure>
          <!-- End Browser Device -->
        </div>
        <!-- End Col -->
        ...
        <div class="col-md-6">
          <div class="pe-md-7">
            <div class="mb-5">
              <div class="mb-5">
                <span class="badge border border-dark text-dark">4 Pages</span>
              </div>
      ...
      <div class="row align-items-md-center content-space-2 content-space-b-lg-2">
        <div class="col-md-6 order-md-2 mb-10 mb-md-0">
          ...
          <figure class="device-browser">
            ...
            <div class="device-browser-frame">
              <img class="device-browser-img" src="./assets/img/1618x1010/img3.jpg" alt="Image Description">
            </div>

            <div class="position-absolute bottom-0 start-0 w-100 h-100 bg-soft-secondary zi-n1 mb-n6 ms-n6"></div>
          </figure>
          <!-- End Browser Device -->
        </div>
        <!-- End Col -->
        ...
        <div class="col-md-6">
          <div class="pe-md-7">
            <div class="mb-5">
              <div class="mb-5">
                <span class="badge border border-dark text-dark">3 Pages</span>
              </div>
    ...
    <div class="content-space-t-2">
      <div class="container">
        <div class="bg-light p-4 p-sm-10">
          ...
          <img class="img-fluid rounded-2 shadow-xl" src="./assets/svg/illustrations/docs-main-page.svg" alt="Image Description">
        </div>
      </div>
    </div>
    <!-- End Documentation -->
    ...
    <div class="container content-space-t-2">
      <div class="p-4 p-sm-10">
        ...
        <img class="img-fluid rounded-2 shadow-xl" src="./assets/svg/illustrations/snippets-main-page.svg" alt="Image Description">
      </div>
    </div>
    <!-- End Snippets -->
    ...
    <div class="position-relative gradient-y-gray">
      <div class="container content-space-2 content-space-b-sm-3 content-space-b-lg-4">
        <!-- Heading -->
        <div class="w-md-75 w-lg-50 text-center mx-md-auto mb-5 mb-md-9">
        ...
        <div class="d-grid mx-auto" style="max-width: 15rem;">
          <a class="btn btn-primary btn-transition" href="https://themes.getbootstrap.com/product/front-multipurpose-responsive-template/" target="_blank">Get a license for $49</a>
        </div>
      </div>
        ...
        <div class="col-md-4">
          <div data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="text-center px-md-3 px-lg-8">
              ...
              <p class="mb-0"><span class="text-dark fw-semibold">4.80 out of 5 starts</span> from 81 reviews</p>
            </div>
            <!-- End Stats -->
          </div>
        </div>
          ...
          <div data-aos="fade-up">
            ...
            <div class="text-center px-md-3 px-lg-8">
              <span class="svg-icon svg-icon-lg mb-3">
                ...
                <g mask="url(#mask0)">
                <path d="M66.5 39C66.5 29.335 58.665 21.5 49 21.5C39.335 21.5 31.5 29.335 31.5 39C31.5 48.665 39.335 56.5 49 56.5C58.665 56.5 66.5 48.665 66.5 39Z" fill="url(#pattern0)" stroke="white" stroke-width="3"/>
                </g>
                ...
                <g mask="url(#mask1)">
                <path d="M51.5 19C51.5 9.33502 43.665 1.5 34 1.5C24.335 1.5 16.5 9.33502 16.5 19C16.5 28.665 24.335 36.5 34 36.5C43.665 36.5 51.5 28.665 51.5 19Z" fill="url(#pattern1)" stroke="white" stroke-width="3"/>
                </g>
                ...
                <g mask="url(#mask2)">
                <path d="M36.5 39C36.5 29.335 28.665 21.5 19 21.5C9.33502 21.5 1.5 29.335 1.5 39C1.5 48.665 9.33502 56.5 19 56.5C28.665 56.5 36.5 48.665 36.5 39Z" fill="url(#pattern2)" stroke="white" stroke-width="3"/>
                </g>
                <defs>
              ...
              <p class="mb-0">Over <span class="text-dark fw-semibold">1k+</span> support questions have been closed</p>
            </div>
            <!-- End Stats -->
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="text-center px-md-3 px-lg-8">
              <span class="svg-icon svg-icon-lg mb-3">
                <svg width="71" height="64" viewBox="0 0 71 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M47.4324 1.59973H19.9038C17.9233 1.59973 16.438 3.08509 16.438 5.06556V55.9638C16.438 57.9442 17.9233 59.4296 19.9038 59.4296H56.0475C58.0279 59.4296 59.5133 57.9442 59.5133 55.9638V47.4477V21.3055V13.8787L47.4324 1.59973Z" stroke="#21325B" stroke-width="1.98047"/>
                <path d="M48.6206 14.8689C47.5313 14.8689 46.8381 13.9776 46.8381 13.0864V2.29285L59.4141 14.8689H48.6206Z" fill="#21325B"/>
                <path d="M47.7294 21.1074H27.7266" stroke="#21325B" stroke-width="1.98047" stroke-linecap="round"/>
                <path d="M47.7294 27.9401H27.7266" stroke="#21325B" stroke-width="1.98047" stroke-linecap="round"/>
                <path d="M47.7294 34.7727H27.7266" stroke="#21325B" stroke-width="1.98047" stroke-linecap="round"/>
                <path d="M47.7294 41.9023H27.7266" stroke="#21325B" stroke-width="1.98047" stroke-linecap="round"/>
              ...
              <p class="mb-0"><span class="text-dark fw-semibold">5k+</span> Front copies have been purchased</p>
            </div>
            <!-- End Stats -->
          </div>
        </div>
