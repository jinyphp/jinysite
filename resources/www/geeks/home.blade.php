            ...
            @includeIf(inSlotPartial("hero.hero1"))
            ...
            @includeIf(inSlotPartial("hero.cate_tile1"))

            @includeIf(inSlotPartial("slider.courses"))

            @includeIf(inSlotPartial("slider.reviews"))
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-8 col-12 mx-auto">
                            <div class="d-flex flex-column gap-2 text-center mb-xl-7 mb-5">
                                <h2 class="mb-0 h1">코딩 연습 및 채용 평가</h2>
