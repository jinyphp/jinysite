                                ...
                                <div class="d-flex flex-row gap-5">
                                    ...
                                    <div class="d-flex flex-column gap-4">
                                        <div class="d-flex flex-column gap-2">
                                            ...
                                            <p class="mb-0 pe-xl-4">Lorem ipsum dolor sit amet, consectetur adi piscing elit.
                                                Aliquam sollicitudin eros enim, sed semper nunc tincidunt non.</p>
                                        </div>
                                        <div class="">
                                            <a href="#!" class="icon-link icon-link-hover">
                                ...
                                <div class="d-flex flex-row gap-5">
                                    ...
                                    <div class="d-flex flex-column gap-4">
                                        <div class="d-flex flex-column gap-2">
                                            ...
                                            <p class="mb-0 pe-xl-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                Aliquam sollicitudin eros enim, sed semper nunc tincidunt non.</p>
                                        </div>
                                        <div>
                                            <a href="#!" class="icon-link icon-link-hover">
