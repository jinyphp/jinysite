                      ...
                      <div class="col-md-4 col-xl-3">
                        <div class="card border mb-6 mb-md-0 shadow-none">
                            ...
                            <div class="collapse show" id="collapseExample">
                              <div class="mt-3">
                                ...
                                <div class="collapse" id="collapseContent">
                                  ...
                                  <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" value="" id="flexCheckLocationSix " />
                                    <label class="form-check-label" for="flexCheckLocationSix ">
                                      Rajkot
                                      <span>(412)</span>
                                    </label>
                                  </div>
                          ...
                          <div class="card-body border-top py-3">
                            <a class="fs-5 text-dark fw-semibold" data-bs-toggle="collapse" href="#collapseExampleSecond" role="button" aria-expanded="false" aria-controls="collapseExampleSecond">
                              Salary
                              <span class="float-end">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-chevron-down" viewBox="0 0 16 16">
                                  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"></path>
                            ...
                            <div class="collapse show" id="collapseExampleSecond">
                              <div class="mt-3">
                                <div class="form-check mb-2">
                                  <input class="form-check-input" type="checkbox" value="" id="flexCheckSalaryOne" />
                                  <label class="form-check-label" for="flexCheckSalaryOne">0-3 Lakhs</label>
                                </div>
                                <div class="form-check mb-2">
                                  <input class="form-check-input" type="checkbox" value="" id="flexCheckSalaryTwo " checked />
                                  <label class="form-check-label" for="flexCheckSalaryTwo ">3-6 Lakhs</label>
                                </div>
                                <div class="form-check mb-2">
                                  <input class="form-check-input" type="checkbox" value="" id="flexCheckSalaryThree " />
                                  <label class="form-check-label" for="flexCheckSalaryThree ">6-10 Lakhs</label>
                                </div>
                                <div class="form-check mb-2">
                                  <input class="form-check-input" type="checkbox" value="" id="flexCheckSalaryFour " />
                          ...
                          <div class="card-body border-top py-3">
                            <a class="fs-5 text-dark fw-semibold" data-bs-toggle="collapse" href="#collapseExampleThird" role="button" aria-expanded="false" aria-controls="collapseExampleThird">
                              Last updated
                              <span class="float-end">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-chevron-down" viewBox="0 0 16 16">
                                  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"></path>
                            ...
                            <div class="collapse show" id="collapseExampleThird">
                              <div class="mt-3">
                                <label class="form-label visually-hidden" for="jobLastUpdate">Last Update</label>
                                <select class="form-select" data-choices="" id="jobLastUpdate" name="jobLastUpdate">
                          ...
                          <div class="card-body border-top py-3">
                            ...
                            <div class="collapse show" id="collapseExampleFourth">
                              <div class="mt-3">
                                ...
                                <div class="form-check mb-2">
                                  <input class="form-check-input" type="checkbox" value="" id="flexCheckEduSix " checked />
                                  <label class="form-check-label" for="flexCheckEduSix ">MBA / MTech</label>
                                </div>
                                <div class="form-check mb-2">
                                  <input class="form-check-input" type="checkbox" value="" id="flexCheckEduSeven " />
                                  <label class="form-check-label" for="flexCheckEduSeven ">Any Graduate</label>
                                </div>
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox" value="" id="flexCheckEduEight " />
                          ...
                          <div class="col-auto">
                            <div class="d-flex">
                              <div class="nav btn-group flex-nowrap" role="tablist">
                                <a href="job-grid.html" class="btn btn-outline-secondary btn-icon d-flex align-items-center">
                                  <span class="fe fe-grid"></span>
                                </a>
                                <a href="job-listing.html" class="btn btn-outline-secondary active btn-icon d-flex align-items-center">
                            ...
                            <div class="d-xl-flex">
                              ...
                              <div class="ms-xl-3 w-100 mt-3 mt-xl-1">
                                <div class="d-flex justify-content-between mb-4">
                                  <div>
                                    <h3 class="mb-1 fs-4"><a href="job-single.html" class="text-inherit">Senior React Developer</a></h3>
                                    <div>
                          ...
                          <div class="card-body">
                            <div class="d-xl-flex">
                              <div class="mb-3 mb-md-0">
                                ...
                                <img src="../../assets/images/job/job-brand-logo/job-list-logo-3.svg" alt="Geeks Bootstrap 5 Template" class="icon-shape border rounded-circle" />
                              </div>
                              <!-- text -->
                              <div class="ms-xl-3 w-100 mt-3 mt-xl-1">
                                <div class="d-flex justify-content-between mb-4">
                                  <div>
                                    <h3 class="mb-1 fs-4"><a href="job-single.html" class="text-inherit">Software Engineer (Web3/Crypto)</a></h3>
                                    <div>
                                      <span>at Square</span>
                                      <span class="text-dark ms-2 fw-medium">
                                        3.9
                          ...
                          <div class="card-body">
                            <div class="d-xl-flex">
                              <div class="mb-3 mb-md-0">
                                ...
                                <img src="../../assets/images/job/job-brand-logo/job-list-logo-4.svg" alt="Geeks Bootstrap 5 Template" class="icon-shape border rounded-circle" />
                              </div>
                              <!-- text -->
                              <div class="ms-xl-3 w-100 mt-3 mt-xl-1">
                                <div class="d-flex justify-content-between mb-4">
                                  <div>
                                    <h3 class="mb-1 fs-4"><a href="job-single.html" class="text-inherit">Lead Software Engineer</a></h3>
                                    <div>
                                      <span>at Dot</span>
                                      <span class="text-dark ms-2 fw-medium">
                                        4.5
                          ...
                          <div class="card-body">
                            <div class="d-xl-flex">
                              <div class="mb-3 mb-md-0">
                                ...
                                <img src="../../assets/images/job/job-brand-logo/job-list-logo-5.svg" alt="Geeks Bootstrap 5 Template" class="icon-shape border rounded-circle" />
                              </div>
                              <!-- text -->
                              <div class="ms-xl-3 w-100 mt-3 mt-xl-1">
                                <div class="d-flex justify-content-between mb-4">
                                  <div>
                                    <h3 class="mb-1 fs-4"><a href="job-single.html" class="text-inherit">Senior Full Stack Engineer</a></h3>
                                    <div>
                                      <span>at Toggle</span>
                                      <span class="text-dark ms-2 fw-medium">
                                        4.9
