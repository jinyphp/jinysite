                          ...
                          <div class="card-body border-top py-3">
                            ...
                            <div class="collapse show" id="collapseExampleThird">
                              <div class="mt-3">
                                ...
                                <select class="form-select" data-choices="" id="Day">
                          ...
                          <div class="col-auto">
                            <div class="d-flex">
                              <div class="nav btn-group flex-nowrap" role="tablist">
                                <a href="job-grid.html" class="btn btn-outline-secondary active btn-icon d-flex align-items-center">
                                  <span class="fe fe-grid"></span>
                                </a>
                                <a href="job-listing.html" class="btn btn-outline-secondary btn-icon d-flex align-items-center">
                                  <span class="fe fe-list"></span>
                                </a>
                              </div>
                              <div class="ms-3">
                                <label for="sorting" class="visually-hidden">Sorting</label>
                                <select class="form-select" data-choices="" id="sorting">
                                  ...
                                  <div class="d-flex justify-content-between mb-4">
                                    <div>
                                      ...
                                      <h3 class="mb-1 fs-4">
                                        ...
                                        <span class="badge bg-danger-soft">Featured Job</span>
                                      </h3>
                              ...
                              <div class="card-body">
                                ...
                                <div class="w-100 mt-3">
                                  <div class="d-flex justify-content-between mb-4">
                                    <div>
                                      <!-- Job Grid Heading Start-->
                                      <h3 class="mb-1 fs-4"><a href="job-single.html" class="text-inherit">Senior Software Engineer (Ruby on Rails)</a></h3>
                                      <!-- Job Grid Heading End-->
                                ...
                                <div>
                                  <div class="mb-4">
                                    <div class="mb-2 mb-md-0">
                                      <div class="mt-1">
                                        <i class="fe fe-briefcase"></i>
                                        <span class="ms-1">1 - 6 years</span>
                                      </div>
                                      <div class="mt-1">
                                        <i class="fe fe-dollar-sign"></i>
                                        <span class="ms-1">5k - 10k</span>
                                      </div>
                                      <div class="mt-1">
                                        <i class="fe fe-map-pin"></i>
