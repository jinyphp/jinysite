                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 d-flex justify-content-center">
                            ...
                            <div class="position-relative">
                                ...
                                <img src="../../assets/images/background/acedamy-img/girl-image.png" alt="girl" class="w-100 w-md-auto position-absolute end-0 bottom-0" />
                                <img src="../../assets/images/background/acedamy-img/frame-1.svg" alt="frame" class="position-absolute top-0 ms-n8 d-none d-md-inline-block" />
                                <img
                                    src="../../assets/images/background/acedamy-img/frame-2.svg"
                                    alt="frame"
                                    class="position-absolute bottom-0 start-0 ms-lg-n8 ms-n6 mb-n7 d-none d-md-inline-block" />
                                <img src="../../assets/images/background/acedamy-img/target.svg" alt="target" class="position-absolute bottom-0 mb-8 ms-n8 ms-lg-n1 d-none d-md-inline-block" />
                                <img
                                    src="../../assets/images/background/acedamy-img/sound.svg"
                                    alt="sound"
                                    class="position-absolute top-50 mt-n8 ms-n8 d-none d-md-inline-block"
                                    style="left: -100px" />
                                <img src="../../assets/images/background/acedamy-img/trophy.svg" alt="trophy" class="position-absolute top-0 start-0 ms-n8 d-none d-md-inline-block" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <ul class="nav nav-lb-tab mb-6 bg-gray-200 px-5 rounded-3" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="pills-design-tab" data-bs-toggle="pill" href="#pills-design" role="tab" aria-controls="pills-design" aria-selected="false">Design</a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="pills-marketing-tab" data-bs-toggle="pill" href="#pills-marketing" role="tab" aria-controls="pills-marketing" aria-selected="false">
                                        Marketing
                                    </a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="pills-business-tab" data-bs-toggle="pill" href="#pills-business" role="tab" aria-controls="pills-business" aria-selected="false">
                                        Business
                                    </a>
                                </li>
                                <!-- nav item -->
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="pills-health-tab" data-bs-toggle="pill" href="#pills-health" role="tab" aria-controls="pills-health" aria-selected="false">Health</a>
                                </li>
                            </ul>
                            <!-- Tab content -->
                                ...
                                <div class="tab-pane fade show active" id="pills-development" role="tabpanel" aria-labelledby="pills-development-tab">
                                    ...
                                    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                                        ...
                                        <div class="col">
                                            <!-- Card -->
                                            <div class="card card-hover">
                                                <a href="../course-single.html"><img src="../../assets/images/course/course-python.jpg" alt="card" class="card-img-top" /></a>
                                                <!-- Card Body -->
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                                        <span class="badge bg-success-soft">Beginner</span>
                                ...
                                <div class="sliderTestimonial">
                                    ...
                                    <div class="item">
                                        <div class="card">
                                            <div class="card-body text-center p-6">
                                                ...
                                                <p class="mb-0 mt-3">
                                                    “The generated lorem Ipsum is therefore always free from repetition, injected humour, or words etc generate lorem Ipsum which looks racteristic
                                                    reasonable.”
                                                </p>
                                                <!-- rating -->
                                    ...
                                    <div class="item">
                                        <div class="card">
                                            <div class="card-body text-center p-6">
                                                ...
                                                <p class="mb-0 mt-3">
                                                    “Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Proin nec justo risus. Quisque ornare nisl eu mi fermentum”
                                                </p>
                                                <!-- rating -->
                                                <div class="lh-1 mb-3 mt-4">
                                                    <span class="fs-6 align-top">
                                    ...
                                    <div class="item">
                                        <div class="card">
                                            <div class="card-body text-center p-6">
                                                <!-- img -->
                                                <img src="../../assets/images/avatar/avatar-3.jpg" alt="avatar" class="avatar avatar-lg rounded-circle" />
                                                <p class="mb-0 mt-3">
                                                    “Praesent aliquet diam a ligula imperdiet commodo. Donec eleifend, orci et accumsan interdum, ipsum leo porta velit, a placerat neque ex id est.”
                                                </p>
                                                <!-- rating -->
                                                <div class="lh-1 mb-3 mt-4">
                                                    <span class="fs-6 align-top">
                                    ...
                                    <div class="item">
                                        <div class="card">
                                            <div class="card-body text-center p-6">
                                                <!-- img -->
                                                <img src="../../assets/images/avatar/avatar-6.jpg" alt="avatar" class="avatar avatar-lg rounded-circle" />
                                                <p class="mb-0 mt-3">
                                                    “Praesent aliquet diam a ligula imperdiet commodo. Donec eleifend, orci et accumsan interdum, ipsum leo porta velit, a placerat neque ex id est.”
                                                </p>
                                                <!-- rating -->
