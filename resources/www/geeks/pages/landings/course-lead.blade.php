<x-www-app>
    ...
    <main>
            ...
            <div class="row">
              <div class="col-xl-6 col-lg-6 col-md-12">
                <div class="mb-4 mb-xl-0 text-center text-md-start">
                  ...
                  <p class="mb-4 lead">In this tutorial, we are going to learn about JavaScript (Vanilla JS) - for building incredible, powerful JavaScript applications.</p>
                  <!-- List -->
                  <div class="mb-6 mb-0">
                    <ul class="list-unstyled fs-4">
                      <li class="mb-2">
                        <span class="me-2"><i class="fe fe-clock text-warning"></i></span>
                        <span class="align-text-top">4 Hours</span>
                      </li>
                      <li class="mb-2">
                        <span class="me-2"><i class="fe fe-video text-warning"></i></span>
                        <span class="align-text-top">12 Videos</span>
                      </li>
                      <li class="mb-2">
                        <span class="me-2"><i class="fe fe-users text-warning"></i></span>
                        <span class="align-text-top">10,234+ Enrolled</span>
                      </li>
                    </ul>
                  </div>
                  <a href="https://www.youtube.com/watch?v=Nfzi7034Kbg" class="glightbox btn btn-success btn-lg fs-4">Watch Preview</a>
                </div>
              </div>
                ...
                <div class="card smooth-shadow-md" style="z-index: 1">
                  ...
                  <div class="card-body p-xl-6">
                    <div class="mb-4">
                      ...
                      <div class="mt-3 mb-5 row g-2">
                        <!-- btn group -->
                        <div class="btn-group mb-2 mb-md-0 col-md-4" role="group" aria-label="socialButton">
                        ...
                        <div class="btn-group mb-2 mb-md-0 col-md-4" role="group" aria-label="socialButton">
                          <button type="button" class="btn btn-light shadow-sm">
                            <span class="me-1 align-text-bottom">
                              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-twitter text-info" viewBox="0 0 16 16">
                                <path
                        ...
                        <!-- btn group -->
                        <div class="btn-group col-md-4" role="group" aria-label="socialButton">
                          <button type="button" class="btn btn-light shadow-sm">
                            <span class="me-1 align-text-bottom">
                    ...
                    <form class="needs-validation" novalidate>
                      <!-- Username -->
                      <div class="mb-3">
                        <label for="courseLeadEmail" class="form-label visually-hidden">Email</label>
                        <input type="email" id="courseLeadEmail" class="form-control" name="courseLeadEmail" placeholder="Email" required="" />
                        <div class="invalid-feedback">Please enter valid Email.</div>
                      </div>
                      <!-- Password -->
                      <div class="mb-3">
                        <label for="courseLeadPassword" class="form-label visually-hidden">Password</label>
                        <input type="password" id="courseLeadPassword" class="form-control" name="courseLeadPassword" placeholder="Password" required="" />
                  ...
                  <div class="card-footer px-6 py-4">
                    <p class="mb-0">
                      ...
                      <a href="#" class="text-inherit fw-semibold">Terms of Use</a>
                      ,
                      <a href="#" class="text-inherit fw-semibold">Privacy Policy</a>
                      , and
                      <a href="#" class="text-inherit fw-semibold">Data Policy</a>
                    </p>
                  </div>
                </div>
                <!-- Pattern -->
        ...
        <!-- Feature section -->
        <section class="py-4 shadow-sm position-relative bg-white">
          <div class="container">
            <div class="row">
              <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="text-dark fw-semibold lh-1 fs-4 mb-3 mb-lg-0">
                  <span class="icon-shape icon-xs rounded-circle bg-light-warning text-center me-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-check text-danger" viewBox="0 0 16 16">
        ...
        <!-- Section -->
        <section class="py-7 py-lg-8 bg-gray-200">
          <div class="container my-lg-8">
            <div class="row mb-8 justify-content-center">
              <div class="col-lg-8 col-md-12 col-12 text-center">
                ...
                <p class="lead">Vanilla JS is a fast, lightweight, cross-platformframework for building incredible, powerful JavaScript applications.</p>
              </div>
            </div>
            <!-- row -->
            <div class="row">
                  ...
                  <div class="card-body p-6">
                    <div class="d-md-flex mb-4">
                      <div class="mb-3 mb-md-0">
                        <!-- Img -->
                        <img src="../../assets/images/svg/feature-icon-1.svg" alt="icon" class="bg-primary icon-shape icon-xxl rounded-circle" />
                      </div>
                      <!-- Content -->
                      <div class="ms-md-4">
              ...
              <div class="col-lg-6 col-md-12 col-12">
                ...
                <div class="card mb-4">
                  <div class="card-body p-6">
                    <div class="d-md-flex mb-4">
                      <div class="mb-3 mb-md-0">
                        <img src="../../assets/images/svg/feature-icon-2.svg" alt="icon" class="bg-primary icon-shape icon-xxl rounded-circle" />
                      </div>
                      <div class="ms-md-4">
              ...
              <div class="col-lg-6 col-md-12 col-12">
                ...
                <div class="card mb-4">
                  <div class="card-body p-6">
                    <div class="d-md-flex mb-4">
                      <div class="mb-3 mb-md-0">
                        <img src="../../assets/images/svg/feature-icon-3.svg" alt="icon" class="bg-primary icon-shape icon-xxl rounded-circle" />
                      </div>
                      <div class="ms-md-4">
              ...
              <div class="col-lg-6 col-md-12 col-12">
                ...
                <div class="card mb-4">
                  <div class="card-body p-6">
                    <div class="d-md-flex mb-4">
                      <div class="mb-3 mb-md-0">
                        <img src="../../assets/images/svg/feature-icon-4.svg" alt="icon" class="bg-primary icon-shape icon-xxl rounded-circle" />
                      </div>
                      <div class="ms-md-4">
                ...
                <div class="row align-items-center">
                  <div class="col-xl-6 col-lg-7 col-md-12 col-12 order-1 text-center text-lg-start">
                    ...
                    <h2 class="mb-2 display-4 fw-bold mb-3">
                      Hi, I’m
                      <span class="text-primary">James Davies</span>
                      ,
                      <br />
                      I will be taking you through lessons.
                    </h2>
                    <p class="fs-3">Create beautiful website with this Geeks UI template. Get started building a site today.</p>
                  ...
                  <div class="offset-xl-1 col-xl-5 col-lg-5 col-12 mb-6 mb-lg-0 order-lg-2 text-center">
                    <img src="../../assets/images/instructor/instructor-img.png" alt="instructor" class="img-fluid" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="container mb-lg-8">
            <div class="row justify-content-center">
              <div class="col-md-10 col-12">
                <!-- Brand logo -->
                <span class="text-primary mb-3 d-block text-uppercase fw-semibold ls-xl text-center">Trusted by top-tier product companies</span>
                <div class="row mt-8">
                  <!-- logo -->
              ...
              <div class="col-lg-6 col-md-8 col-12">
                <div class="accordion accordion-flush" id="accordionExample">
                  ...
                  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                    <div class="py-3 fs-4">Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.</div>
                  </div>
                  <!-- Card  -->
                  <!-- Card header  -->
