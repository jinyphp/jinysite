                    ...
                    <div>
                      ...
                      <form>
                        <div class="d-flex flex-row align-items-center gap-2">
                          ...
                          <select class="form-select" data-choices="" aria-label="Default select example" id="exampleInputmentees" name="exampleInputmentees">
      ...
      <div class="modal-content">
        <div class="modal-body">
          ...
          <form class="needs-validation" novalidate="">
            <!-- Username -->
            <div class="mb-3">
              <label for="mentorSingleName" class="form-label">User Name</label>
              <input type="text" id="mentorSingleName" class="form-control" name="mentorSingleName" placeholder="User Name" required="" />
              <div class="invalid-feedback">Please enter valid username.</div>
            </div>
            <!-- Email -->
            <div class="mb-3">
              <label for="mentorSingleEmail" class="form-label">Email</label>
              <input type="email" id="mentorSingleEmail" class="form-control" name="mentorSingleEmail" placeholder="Email address here" required="" />
              <div class="invalid-feedback">Please enter valid Email.</div>
            </div>
            <!-- Password -->
            <div class="mb-3">
              <label for="mentorSinglePassword" class="form-label">Password</label>
              <input type="password" id="mentorSinglePassword" class="form-control" name="mentorSinglePassword" placeholder="**************" required="" />
