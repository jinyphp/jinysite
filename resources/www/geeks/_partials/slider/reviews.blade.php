                    ...
                    <div class="card-body p-5 d-flex flex-column gap-3">
                        ...
                        <div class="d-flex flex-column gap-6">
                            <div class="d-flex flex-column gap-2">
                                ...
                                <p class="mb-0">
                                    "I was struggling to grasp the concepts in my subject until I enrolled in this
                                    course. The interactive lessons and the support from the instructors were
                                    incredible. I feel more
                                    confident and prepared for my exams now. Highly recommend it to anyone looking
                                    to excel!"
                                </p>
                            </div>
                    ...
                    <div class="card-body p-5 d-flex flex-column gap-3">
                        ...
                        <div class="d-flex flex-column gap-6">
                            <div class="d-flex flex-column gap-2">
                                ...
                                <p class="mb-0">
                                    "This course exceeded my expectations. The material is presented in a clear and
                                    engaging way, making even the most complex topics easy to understand. The
                                    quizzes and
                                    assignments helped reinforce my learning. I can’t thank the team enough for this
                                    fantastic resource."
                                </p>
                            </div>
                            <div class="d-flex flex-column gap-4">
                    ...
                    <div class="card-body p-5 d-flex flex-column gap-3">
                        ...
                        <div class="d-flex flex-column gap-6">
                            <div class="d-flex flex-column gap-2">
                                ...
                                <p class="mb-0">
                                    "As a working professional, I needed a course that fit into my busy schedule.
                                    This course was perfect! The flexible pacing allowed me to learn at my own
                                    speed, and the
                                    practical applications taught in the course have already helped me in my job.
                                    I’m looking forward to taking more courses from this platform."
                                </p>
                            </div>
                            <div class="d-flex flex-column gap-4">
                                <div class="d-flex flex-row gap-3 align-items-center">
