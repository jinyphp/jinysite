...
<ul class="sidebar-nav">
    ...
    <li class="sidebar-item">
        ...
        <ul id="hr-work1" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
            <li class="sidebar-item">
                <a class="sidebar-link" href="/admin/hr/work/status">
                    근태 모니터링
                </a>
            </li>
            <li class="sidebar-item">
                <a class="sidebar-link" href="/admin/hr/work/time">
                    출퇴근 기록 관리
                </a>
            </li>

            <li class="sidebar-item">
                <a class="sidebar-link" href="/admin/hr/work/overtime">
                    초과 근무 관리
                </a>
            </li>
    ...
    <li class="sidebar-item">
        ...
        <ul id="hr-work" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
            <li class="sidebar-item">
                <a class="sidebar-link" href="/admin/hr/work/type">
                    근무유형
                </a>
            </li>
            <li class="sidebar-item">
                <a class="sidebar-link" href="/admin/hr/work/assign">
                    근무지정
                </a>
            </li>
    ...
    <li class="sidebar-item">
        ...
        <ul id="hr-onboard" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="/admin/hr/position/move">
                    인사이동
                </a>
            </li>
            <li class="sidebar-item">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="/admin/hr/division/move">
                    부서발령
                </a>
            </li>
            <li class="sidebar-item">
    ...
    <li class="sidebar-item">
        ...
        <ul id="hr-vacation" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="/admin/hr/leave/type">
                    휴가목록
                </a>
            </li>
            <li class="sidebar-item">
                <a class="sidebar-link" href="/admin/hr/leave/request">
                    휴가신청
                </a>
            </li>
            <li class="sidebar-item">
    ...
    <li class="sidebar-item">
        ...
        <ul id="hr-payroll" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
            <li class="sidebar-item">
                <a class="sidebar-link" href="/admin/hr/payroll/wage">
                    최저시급
                </a>
            </li>
            <li class="sidebar-item">
                <a class="sidebar-link" href="/admin/hr/payroll/salary">
                    계약조건
                </a>
            </li>
            <li class="sidebar-item">
    ...
    <li class="sidebar-item">
        ...
        <ul id="hr-recruit" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
            <li class="sidebar-item">
                <a class="sidebar-link" href="/admin/hr/recruit/plan">
                    충원요청
                </a>
            </li>
            <li class="sidebar-item">
